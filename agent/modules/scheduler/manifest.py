            ...
            parameters=[
                ...
                ToolParameter(
                    ...
                    description=(
                        ...
                        "\"success_values\": [\"completed\", \"failed\", \"timed_out\", \"awaiting_input\"]}. "
                        "IMPORTANT: use \"args\" for tool arguments (not \"params\"), "
                        "\"success_field\" for the field to check (not \"field\"), "
                        "and \"success_values\" for target values (not \"target_values\"). "
