        ...
        ToolDefinition(
            ...
            parameters=[
                ToolParameter(
                    name="project_id",
                    type="string",
                    description="Project to run as a crew",
                    required=True,
                ),
                ToolParameter(
                    name="name",
                ...
                ToolParameter(
                    name="max_agents",
                    type="integer",
                    description="Maximum concurrent agents (default 4, max 6)",
                    required=False,
                ),
                ToolParameter(
                    name="role_assignments",
                    type="object",
                    description="Map of task_id → role (architect|backend|frontend|tester|reviewer)",
                    required=False,
                ),
                ToolParameter(
                    name="auto_push",
                    type="boolean",
                    description="Auto-push branches after completion (default true)",
                    required=False,
                ),
                ToolParameter(
                    name="timeout",
                    type="integer",
                    description="Timeout per agent in seconds (default 1800)",
                    required=False,
                ),
            ],
        ...
        ToolDefinition(
            ...
            parameters=[
                ToolParameter(
                    name="status_filter",
                    type="string",
                    description="Filter by status (configuring|running|paused|completed|failed)",
                    required=False,
                ),
            ],
            required_permission="user",
        ...
        ToolDefinition(
            ...
            parameters=[
                ...
                ToolParameter(
                    name="entry_type",
                    type="string",
                    description="Entry type: decision|api_contract|interface|note|blocker",
                    required=True,
                ),
                ToolParameter(
                    name="title",
        ...
        ToolDefinition(
            ...
            parameters=[
                ...
                ToolParameter(
                    name="member_id",
                    type="string",
                    description="Crew member ID that completed",
                    required=True,
                ),
                ToolParameter(
                    name="claude_task_id",
                    type="string",
                    description="Claude Code task ID of the completed member",
                    required=True,
                ),
            ],
            required_permission="admin",
